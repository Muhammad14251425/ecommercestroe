...
const Product = ({product,bg}:Props) => {
  ...
  return (
    ...
    <div className="w-full relative group border-[1px] border-black hover:shadow-lg duration-200 rounded-md shadow-gray-500 p-1 bg-white">
        <div className="w-full h-80 flex items-center justify-center bg-white overflow-hidden">
            <div className={`${bg}`}>
                ...
                <div className="bottom-0 flex items-center gap-5 justify-center translate-y-[110%] group-hover:-translate-y-2 transition-transform duration-300">
                    ...
                    className="bg-gray-800 text-gray-200 px-4 py-2 text-xs rounded-full items-center flex gap-1 hover:bg-gray-950
                    hover:text-white duration-200">
                        <span><AiOutlineShopping /></span>
                        Add to Cart
                    </button>
                    <Link href={`/product/${product.slug.current}`} className="bg-gray-800 text-gray-200 px-4 py-2 text-xs rounded-full items-center flex gap-1 hover:bg-gray-950
                    hover:text-white duration-200">
