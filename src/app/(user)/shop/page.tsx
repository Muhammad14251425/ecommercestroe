  ...
  return (
    <Container>
      ...
      <div className='flex items-center gap-4'>
        ...
        className={`${showGrid ? 'bg-primeColor text-white':'border-[1px] border-gray-300 text-[#737373]'} w-8 h-8
        ...
        className={`${showList ? 'bg-primeColor text-white':'border-[1px] border-gray-300 text-[#737373]'} w-8 h-8
         text-lg flex items-center justify-center cursor-pointer listView`}>
          <ImList />
        </span>
      </div>
      </div>
